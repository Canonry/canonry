...
export const SCHEDULE_CLI_COMMANDS: readonly CliCommandSpec[] = [
  {
    path: ['schedule', 'set'],
    usage: 'canonry schedule set <project> (--preset <preset> | --cron <expr>) [--kind answer-visibility|traffic-sync|gbp-sync] [--source <id>] [--timezone <tz>] [--provider <name>...] [--format json]',
    options: {
      preset: stringOption(),
      cron: stringOption(),
      kind: stringOption(),
    ...
    run: async (input) => {
      const usage = 'canonry schedule set <project> (--preset <preset> | --cron <expr>) [--kind answer-visibility|traffic-sync|gbp-sync] [--source <id>] [--timezone <tz>] [--provider <name>...] [--format json]'
  ...
  {
    path: ['schedule', 'show'],
    usage: 'canonry schedule show <project> [--kind answer-visibility|traffic-sync|gbp-sync] [--format json]',
  ...
  },
  {
    ...
    usage: 'canonry schedule enable <project> [--kind answer-visibility|traffic-sync|gbp-sync] [--format json]',
    options: { kind: stringOption() },
    run: async (input) => {
  ...
  },
  {
    ...
    usage: 'canonry schedule disable <project> [--kind answer-visibility|traffic-sync|gbp-sync] [--format json]',
    options: { kind: stringOption() },
    run: async (input) => {
  ...
  },
  {
    ...
    usage: 'canonry schedule remove <project> [--kind answer-visibility|traffic-sync|gbp-sync] [--format json]',
    options: { kind: stringOption() },
    run: async (input) => {
