...
export const MCP_OPENAPI_OPERATION_CLASSIFICATIONS = {
  ...
  'GET /api/v1/projects/{name}/agent/conversations': 'included',
  'POST /api/v1/projects/{name}/agent/conversations': 'included',
  'GET /api/v1/projects/{name}/agent/conversations/{id}': 'included',
  'POST /api/v1/projects/{name}/agent/conversations/{id}/resume': 'included',
  'DELETE /api/v1/projects/{name}/agent/conversations/{id}': 'included',
