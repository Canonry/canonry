...
export const OPERATIONS_GUIDE = {
  ...
  "workflows": {
    ...
    "measurement": {
      ...
      "guidance": "Inspect existing measurement before editing it. Preserve Simple versus Advanced scope, Property/Target identity, market, provider/model, and query class. Research is separate from tracking; publication does not authorize a sweep."
    },
    "integrations": {
      "keywords": [
        "integrations",
