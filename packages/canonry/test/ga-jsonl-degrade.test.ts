...
const TRAFFIC_DTO = {
  ...
  aiReferrals: [
    { source: 'chatgpt.com', medium: 'referral', trafficClass: 'organic', sourceDimension: 'session', sessions: 5, users: 4 },
  ],
  aiReferralLandingPages: [
    { landingPage: '/pricing', source: 'chatgpt.com', medium: 'referral', trafficClass: 'organic', sourceDimension: 'session', sessions: 12, users: 10 },
  ],
  socialReferrals: [
