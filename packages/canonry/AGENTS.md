...
| `src/mcp/tool-registry.ts` | All API tools (99, including `canonry_report`, `canonry_analytics_metrics`, `canonry_analytics_sources`, and `canonry_gbp_places`), each tagged with a `tier` (`core` or one of the toolkit names) |
