...
const SCHEMA_TABLE = {
  ...
  EngineConnectionPublicDto: engineConnectionPublicDtoSchema,
  EngineConnectionModelCatalogResponse: engineConnectionModelCatalogResponseSchema,
  EngineConnectionUpsertInput: engineConnectionUpsertInputSchema,
  EngineRouteConfig: engineRouteConfigSchema,
  EngineRouteSummaryResponse: engineRouteSummaryResponseSchema,
  EngineRouteUpsertInput: engineRouteUpsertInputSchema,
